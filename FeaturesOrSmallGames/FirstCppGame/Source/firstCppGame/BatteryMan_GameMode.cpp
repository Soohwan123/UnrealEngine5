...
void ABatteryMan_GameMode::BeginPlay() {
	...
	GetWorldTimerManager().SetTimer(
		UnusedHandle, this, &ABatteryMan_GameMode::SpawnPlayerRecharge, FMath::RandRange(2, 5), true); // every 2 to 5 sec it's gonna spawn the balls
}
...
{
	float RandX = FMath::RandRange(Spawn_X_Min, Spawn_X_Max); // It's gonna be spawned in a random level in the range
